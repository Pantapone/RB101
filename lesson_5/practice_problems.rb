...
munsters.each_value do |value|
  total_age_male += value["age"] if value["gender"] == "male"
end
puts total_age_male
...
# Practice Problem 10
old_hash = [{a: 1}, {b: 2, c: 3}, {d: 4, e: 5, f: 6}]
new_hash = old_hash.map do |hash|
  new_hash = {}
...
hsh.map do |key, value|
  if value[:type] == "fruit"
    value[:colors].map do |color|
      arr_fruits << color.capitalize!
    end
  elsif value[:type] == "vegetable"
    arr_fruits << value[:size].upcase!
  end
end

puts arr_fruits.inspect
